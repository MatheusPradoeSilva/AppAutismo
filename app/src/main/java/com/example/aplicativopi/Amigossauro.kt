...
class Amigossauro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menu!!.setOnClickListener {
            val intent = Intent(this@Amigossauro, Menu::class.java)
        ...
        textureView.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                try {
                    ...
                    val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.amigossauro)
    ...
    private fun linkvideo() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=_yoR5hE8y4Y&pp=ygULYW1pZ29zc2F1cm8%3D"))
