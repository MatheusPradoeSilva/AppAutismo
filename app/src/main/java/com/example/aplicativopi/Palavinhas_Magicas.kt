...
class Palavinhas_Magicas : AppCompatActivity() {
        ...
        textureView.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                try {
                    ...
                    val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.palavras)
    ...
    private fun viewpdf() {
        ...
        val intent = Intent(
            Intent.ACTION_VIEW,
            Uri.parse("https://drive.google.com/file/d/1gKr_FCg3Vekqx3jgh5O4KZ8xdpQBISyf/view?usp=sharing")
        )
    ...
    private fun linkvideo() {
        // add the link of pdf
        val intent =
            Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=dX2N6eCenuw&t=1s&ab_channel=ODi%C3%A1riodeMika"))
