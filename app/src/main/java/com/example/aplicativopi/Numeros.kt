...
class Numeros : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menu!!.setOnClickListener {
            val intent = Intent(this@Numeros, Menu::class.java)
        ...
        textureView.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                try {
                    ...
                    val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.num)
        ...
        dentinhospdf = findViewById<View>(R.id.numpdf) as TextView
    ...
    private fun viewpdf() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/13V63HSQg5FnFltvZhjsvkUA6J4BGNvik/view?usp=sharing"))
    ...
    private fun linkvideo() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("hhttps://www.youtube.com/watch?v=AcGQ8dsGsN0&pp=ygUObnVtZXJvIGNhbsOnYW8%3D"))
