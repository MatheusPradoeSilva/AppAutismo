...
class Selvagens : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menu!!.setOnClickListener {
            val intent = Intent(this@Selvagens, Menu::class.java)
        ...
        textureView.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                try {
                    ...
                    val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.selvaens)
        ...
        dentinhospdf = findViewById<View>(R.id.selvagenspdf) as TextView
    ...
    private fun linkvideo() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=BLYr11fcC58&t=2s&pp=ygUkYW5pbWFpcyBzZWx2YWdlbnNlZHVjYcOnw6NvIGluZmFudGls"))
