...
class Origanizacao : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menu!!.setOnClickListener {
            val intent = Intent(this@Origanizacao, Menu::class.java)
        ...
        textureView.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                try {
                    ...
                    val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.organizacao)
        ...
        origapdf = findViewById<View>(R.id.origapdf) as TextView
        origapdf!!.setOnClickListener {
            viewpdf() }
    ...
    private fun viewpdf() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("hhttps://drive.google.com/file/d/14DTXBBL5X8aGkIr203w-WFFUUMuLH3fW/view?usp=sharing"))
    ...
    private fun linkvideo() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=Izt-Cnjsksw&pp=ygUTb3JnYW5pemHDp8OjbyAgbWlrYQ%3D%3D"))
