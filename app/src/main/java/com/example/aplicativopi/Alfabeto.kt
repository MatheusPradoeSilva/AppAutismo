...
class Alfabeto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menu!!.setOnClickListener {
            val intent = Intent(this@Alfabeto, Menu::class.java)
        ...
        textureView.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
            override fun onSurfaceTextureAvailable(
                ...
                try {
                    ...
                    val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.alfabeto)
    ...
    private fun linkvideo() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=E_rXeXyhHyM&pp=ygUNeHV4YSBhbGZhYmV0bw%3D%3D"))
